	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-1">
						<div id="fh5co-logo"><a href="/learn/index.php">Learn<span>.</span></a></div>
					</div>
					<div class="col-xs-11 text-right menu-1">
						<ul>
							<li><a href="/learn/index.php">Home</a></li>
							<li class="active"><a href="/learn/courses.php">Courses</a></li>
							<li><a href="/learn/pricing.php">Pricing</a></li>
							<li><a href="/learn/blog.php">Blog</a></li>
							<li><a href="/learn/contact.php">Contact</a></li>
